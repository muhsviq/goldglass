...
$tip=0;
		...
		for($i=1; $i<= $hidsay; $i++ ){
			...
			$update = MYSQLI_QUERY($connection,"UPDATE product SET `cat_id`='$category_id', `name` = '$name', `text` = '$text', `text2` = '$text2', `status` = '$active', `url_tag` = '$url_tag', `title` = '$title', `keyword` = '$keyword',`checkbox` = '$checkbox',`description` = '$description', `qiymet` = '$qiymet', `qiymet2` = '$qiymet2'  WHERE u_id='".$idx."' AND l_id='".$i."'");
		...
		<form action="" method="POST" enctype="multipart/form-data">
			<table cellpadding="0" cellspacing="0" border="0" align="center">
				...
				<tr>
					<td style="color:black;">Ana sehifede gorunsun: <input type="checkbox" value="1" name="checkbox" ></td>
				</tr>
